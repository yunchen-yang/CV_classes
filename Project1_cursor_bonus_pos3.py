...
###
your_dir="/Users/yangyunchen/Dropbox/Python/proj1_cse573/"
##PLEASE FILL IN YOUR FOLDER DIRECTORY PATH HERE##

for i_c in range(1,7):
    dir_str=your_dir+"task3/task3_bonus/pos3/t3_"+str(i_c)+".jpg"
    img_p_o=cv2.imread(dir_str)
    img_p=cv2.imread(dir_str)

    tem=cv2.imread(your_dir+"task3/task3_bonus/tem_3.jpg")
    ...
    dir_str_2=your_dir+"task3/task3_bonus/pos3/cursor"+str(i_c)+".png"
