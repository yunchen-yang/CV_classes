...
for i_c in range(1,10):
    dir_str=your_dir+"task3/images/neg/neg_"+str(i_c)+".jpg"
    img_p_o=cv2.imread(dir_str)
    img_p=cv2.imread(dir_str)

    temo=cv2.imread(your_dir+"task3/template.png")
    tem=temo[6:30,5:19]
    ...
    dir_str_2=your_dir+"task3/images/neg/negwrite/cursor"+str(i_c)+".png"
