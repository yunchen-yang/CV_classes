...
cv2.imwrite(path+"task1_sift1.jpg",img1_k)
cv2.imwrite(path+"task1_sift2.jpg",img2_k) 
cv2.imwrite(path+"task1_matches_knn.jpg",img_match_knn)
cv2.imwrite(path+"task1_matches.jpg",img_homo_rand)
cv2.imwrite(path+"task1_pano.jpg",img_pano)
