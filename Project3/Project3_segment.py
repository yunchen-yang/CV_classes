...
cv2.imshow('img_thre145',img_thre145)
cv2.imshow('img_thre180',img_thre180)
cv2.imshow('img_thre195',img_thre195)
cv2.imshow('img_thre210',img_thre210)

cv2.imshow('img_thre_op',img_thre_op)
cv2.imshow('img_threopop',img_threopop)
