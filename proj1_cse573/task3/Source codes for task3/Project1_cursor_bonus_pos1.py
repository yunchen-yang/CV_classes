...
for i_c in range(1,7):
    dir_str=your_dir+"task3/task3_bonus/pos1/t1_"+str(i_c)+".jpg"
    img_p_o=cv2.imread(dir_str)
    img_p=cv2.imread(dir_str)

    tem=cv2.imread(your_dir+"task3/task3_bonus/tem_1.jpg")
    ...
    dir_str_2=your_dir+"task3/task3_bonus/pos1/cursor"+str(i_c)+".png"
