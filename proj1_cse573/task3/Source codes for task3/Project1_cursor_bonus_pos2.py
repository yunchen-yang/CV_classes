...
for i_c in range(1,7):
    dir_str=your_dir+"task3/task3_bonus/pos2/t2_"+str(i_c)+".jpg"
    img_p_o=cv2.imread(dir_str)
    img_p=cv2.imread(dir_str)

    tem=cv2.imread(your_dir+"task3/task3_bonus/tem_2.jpg")
    ...
    dir_str_2=your_dir+"task3/task3_bonus/pos2/cursor"+str(i_c)+".png"
